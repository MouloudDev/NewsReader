...
export default function RelatedArticles({ articles }) {
  ...
  const newsCardStyles = {
    wrapperStyles: "flex flex-col justify-start p-2 rounded-lg bg-white hover:bg-zinc-100 border border-white hover:border hover:border-gray-400 transition-all duration-300 dark:bg-[#2c2c2c] dark:border-gray-300 dark:hover:bg-zinc-800",
