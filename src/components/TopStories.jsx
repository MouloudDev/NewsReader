...
export default function TopStories() {
  ...
  return (
    <div className="flex justify-center gap-4 mx-auto mt-2 max-w-screen-xl">
      <div className="flex flex-col flex-grow h-[650px] ">
        <h1 className="text-4xl font-bold text-start mb-3 leading-tight">Top Stories</h1>
        <div className="flex border-2 border-gray-300 rounded-lg shadow-sm max-w-[900px] flex-grow">
          <div
          ...
          <div className="w-full transition-opacity duration-500 ease-in-out flex flex-col">
            ...
            <div className="flex flex-col justify-between p-1 h-full">
              <div>
                ...
                >
                  <h2 className="text-left font-bold text-xl mb-2 hover:underline transition-all duration-300 cursor-pointer line-clamp-2">
                    {currArticle.title.slice(0, 100) + "..."}
                  </h2>
                </Link>
                <p className="text-sm text-left line-clamp-4 hover:opacity-80 transition-opacity duration-300">
                  {currArticle.text.slice(0, 300) + "..."}
                </p>
              </div>
              <div className="flex items-center mt-2">
                <span className="text-base font-semibold truncate max-w-[150px]">
                  {currArticle.source || currArticle.author}
                </span>
                <span className="text-sm font-normal text-[#A6A4A4] ml-1 truncate sm:ml-2">
